...
export const UserProfileModal = ({ onClose }) => {
  ...
  useEffect(() => {
    ...
    if (storedAddresses) {
      ...
      // Direcciones iniciales por defecto
  ...
  // Helper para persistir las direcciones
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-slate-950/60 backdrop-blur-sm transition-all duration-300">
      {/* Capa exterior para cerrar al presionar fuera */}
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-4 space-y-4">
            ...
            <form onSubmit={handleSaveProfile} className="p-4 space-y-4">
              <div>
                ...
                <div className="relative">
                  <div className="absolute left-3 top-1/2 -translate-y-1/2 w-7 h-7 rounded-lg bg-slate-100 flex items-center justify-center">
                  ...
                  <input
                    ...
                    className="
                      w-full h-11 pl-12 pr-3
                      rounded-xl bg-slate-50 border border-slate-200
                      text-xs font-medium text-slate-800 placeholder:text-slate-400
              ...
              <button
                ...
                className="
                  ...
                  rounded-xl shadow-lg shadow-orange-500/20
                  transition-all
              ...
              <div className="flex items-center justify-between gap-3">
                ...
                {!showAddAddress && (
                  <button
                    ...
                    className="
                      h-8 px-2.5 rounded-xl
                      bg-orange-50 hover:bg-orange-100 border border-orange-200
                      text-orange-600 text-[10px] font-black
              ...
              {showAddAddress && (
                <form
                  ...
                  className="
                    ...
                    border border-orange-200 space-y-3 animate-fadeIn
                  "
                >
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="
                        w-7 h-7 rounded-lg bg-white/70 hover:bg-white
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="
                        w-full h-10 px-3 text-xs rounded-xl bg-white
                        border border-orange-100 outline-none
                  ...
                  <button
                    type="submit"
                    className="
                      w-full h-10 bg-orange-500 hover:bg-orange-600
                      text-white font-black text-xs rounded-xl
                      shadow-sm transition-all active:scale-[0.98] cursor-pointer
                    "
                  >
                    Guarda ubicación
                  </button>
                  ...
                  {addresses.map((item) => (
                    <div
                      ...
                      className="
                        ...
                        rounded-2xl bg-slate-50 hover:bg-orange-50/60
                        border border-slate-100 hover:border-orange-100 transition-all
                      "
                    >
                      ...
                      <button
                        ...
                        className="
                          ...
                          transition-all active:scale-90 cursor-pointer shrink-0
                        "
                      >
          ...
          {/* Footer Informativo */}
          <div className="flex items-center justify-center gap-2 px-4 py-3 text-[9px] text-slate-400">
            <span>🔒</span>
            <span>
